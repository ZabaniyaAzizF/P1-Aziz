              ...
              <tr>
                ...
                {{-- <td>
                  <button 
                    ...
                    data-id="{{ $peminjam->id }}"
                    data-book="{{ $peminjam->buku ? $peminjam->buku->title : 'N/A' }}"
                    data-user="{{ $peminjam->user ? $peminjam->user->name : 'N/A' }}"
                    data-pinjam="{{ $peminjam->tanggal_pinjam }}"
                    data-kembali="{{ $peminjam->tanggal_kembali }}"
                    data-paid="{{ $peminjam->is_paid }}"
                  >
