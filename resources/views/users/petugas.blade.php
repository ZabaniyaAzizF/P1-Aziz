  ...
  <div class="main-content">
    ...
    <div class="card mb-4">
      <div class="card-header bg-success text-white">
        <h5 class="mb-4">Add/Edit User Petugas</h5>
      </div>
      <div class="card-body">
        <form id="usersForm" action="{{ route('users.petugas.store') }}" method="POST">
          @csrf
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="role" id="role" class="form-control" value="Petugas" required readonly>
            </div>  
            <div class="col-md-6">
    ...
    <div class="card">
      <div class="card-header bg-primary text-white">
        ...
        <a href="{{ route('users.petugas.invoice') }}" class="btn btn-warning"><i class="bx bx-user-plus"></i> Invoice </a>
      </div>
      <div class="card-body">
